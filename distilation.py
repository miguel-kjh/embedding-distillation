...
def parse_args() -> dict:
    ...
    parser.add_argument("--large_model", type=str, default="EleutherAI/pythia-410m", help="Large model path")
    parser.add_argument("--small_model", type=str, default="EleutherAI/pythia-70m", help="Small model path")
